...
int horizonGoal = 3; // possible inputs: 0-13
int verticalGoal = 2; // possible inputs: 0-5
// Please put in the location of the object that will change

// Please put in the location of the object that is set permanently
int horizonGoalset = 3; // possible inputs: 0-13
int verticalGoalset = 3; // possible inputs: 0-5
// Please put in the location of the object that is set permanently

int sechoriGoalset = 2, secvertiGoalset = 1;

int sechoriGoal = 2, secvertiGoal = 1;
...
enum state {StopState = 0,HoriState = 1, VertiState = 2, Turnleft = 3, Turnright = 4, DetectState = 5, TurnBack = 6, BackHori = 7, BackVerti = 8, Finish = 9 };
void loop() {
switch (state)
{
  case StopState:
  ...
  if(horizonGoal == 0 && (sechoriGoal != 0) )
  {
    state = VertiState;
  }
  ...
  else if(secvertiGoal == 0 && sechoriGoal == 0)
  {
    state = StopState;
  }
