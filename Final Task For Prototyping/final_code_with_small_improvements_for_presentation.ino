...
int verticalGoal = 4; // possible inputs: 0-5
// Please put in the location of the object that will change

// Please put in the location of the object that is set permanently
int horizonGoalset = 1; // possible inputs: 0-13
int verticalGoalset = 4; // possible inputs: 0-5
// Please put in the location of the object that is set permanently

int sechoriGoalset = 1, secvertiGoalset = 1;

int sechoriGoal = 1, secvertiGoal = 1;
...
void turnRight()
{
         ...
         {
         analogWrite(5, 110); //ENA pin
         analogWrite(10, 130); //ENB pin
